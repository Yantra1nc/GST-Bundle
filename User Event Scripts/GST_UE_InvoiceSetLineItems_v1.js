 ...
 */
define(['N/record', 'N/search', 'N/runtime', 'N/ui/serverWidget', 'N/log'],

    function(record, search, runtime, serverWidget, log) {
        ...
        function beforeSubmit(scriptContext) {
            ...
            try {
                ...
                var getSubsidiary = scriptObj.getParameter({
                    name: 'custscript_gst_sales_ue_indiasubsi_v1'
                });
               ...
               // getIndiaSubsidiary.push(getSubsidiary);
                ...
                if (indiaSubObj && (indiaSubObj.indexOf(subsidiary) != -1)) {
                    /*  if (runtime.executionContext === runtime.ContextType.CSV_IMPORT){
                           ...
                           var mode1  = runtime.ContextType;
                           log.debug('context type__',mode1);

                           var mode2  = runtime.ContextType;
                           log.debug('CSV IMPORT mode__',mode2);

                           var mode3 = scriptContext.type;
                           log.debug('mode3__',mode3);
            ...
            try {
                ...
                if (indiaSubObj && (indiaSubObj.indexOf(subsidiary) != -1)) {
                    ...
                    /* if (runtime.executionContext === runtime.ContextType.CSV_IMPORT) {
                           ...
                           log.debug('runtime.ContextType AS__',runtime.ContextType);
                           return;
        ...
        function submitInvoice(invoiceObject) {
            ...
            if (indiaSubObj && (indiaSubObj.indexOf(subsi) != -1)) {
